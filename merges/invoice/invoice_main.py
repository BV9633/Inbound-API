...
from invoice import invoice_update,pdf_extractor,fetch_invoice,timestamp,schemas,document_ai_service1
...
@invoice_router.post("/insert_invoice",response_model=str)
...
def revalidate_invoice(invoice_id: str):
    ...
    try:
        ...
        pdf_gcs_path=pdf_extractor.get_invoice_pdfs(invoice_id)
        pdf_url=""
        if len(pdf_gcs_path):
