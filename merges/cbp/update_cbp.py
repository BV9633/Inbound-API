...
class CBPUpdater:
    ...
    SCALAR_FIELDS=[
        ...
        'entry_no_1_y4_coordinate', 
        'entry_no_2', 'entry_no_2_confidence_score', 'entry_no_2_page_number', 'entry_no_2_x1_coordinate', 
        'entry_no_2_y1_coordinate', 'entry_no_2_x2_coordinate', 'entry_no_2_y2_coordinate','entry_no_2_x3_coordinate', 
        'entry_no_2_y3_coordinate', 'entry_no_2_x4_coordinate', 'entry_no_2_y4_coordinate', 
        ...
        'port_code_no_y4_coordinate', 
        'port_of_unlading', 'port_of_unlading_confidence_score','port_of_unlading_page_number', 
        'port_of_unlading_x1_coordinate', 'port_of_unlading_y1_coordinate','port_of_unlading_x2_coordinate',
        'port_of_unlading_y2_coordinate', 'port_of_unlading_x3_coordinate','port_of_unlading_y3_coordinate',
        'port_of_unlading_x4_coordinate', 'port_of_unlading_y4_coordinate', 
        'port_of_entry', 'port_of_entry_confidence_score', 'port_of_entry_page_number','port_of_entry_x1_coordinate',
        'port_of_entry_y1_coordinate', 'port_of_entry_x2_coordinate','port_of_entry_y2_coordinate',
        'port_of_entry_x3_coordinate', 'port_of_entry_y3_coordinate', 'port_of_entry_x4_coordinate', 
        'port_of_entry_y4_coordinate', 
        'date_of_unlading','date_of_unlading_confidence_score', 'date_of_unlading_page_number', 
        'date_of_unlading_x1_coordinate','date_of_unlading_y1_coordinate','date_of_unlading_x2_coordinate',
        'date_of_unlading_y2_coordinate','date_of_unlading_x3_coordinate','date_of_unlading_y3_coordinate',
        'date_of_unlading_x4_coordinate','date_of_unlading_y4_coordinate', 
        'imported_by','imported_by_confidence_score','imported_by_page_number','imported_by_x1_coordinate',
        'imported_by_y1_coordinate', 'imported_by_x2_coordinate','imported_by_y2_coordinate','imported_by_x3_coordinate', 'imported_by_y3_coordinate', 
        'imported_by_x4_coordinate', 'imported_by_y4_coordinate',
        'importer_id_IRS','importer_id_IRS_confidence_score','importer_id_IRS_page_number',
        'importer_id_IRS_x1_coordinate','importer_id_IRS_y1_coordinate','importer_id_IRS_x2_coordinate',
        'importer_id_IRS_y2_coordinate','importer_id_IRS_x3_coordinate','importer_id_IRS_y3_coordinate',
        'importer_id_IRS_x4_coordinate','importer_id_IRS_y4_coordinate',
        'in_bond_via', 'in_bond_via_confidence_score', 'in_bond_via_page_number','in_bond_via_x1_coordinate',
        'in_bond_via_y1_coordinate', 'in_bond_via_x2_coordinate','in_bond_via_y2_coordinate',
        'in_bond_via_x3_coordinate', 'in_bond_via_y3_coordinate','in_bond_via_x4_coordinate', 'in_bond_via_y4_coordinate', 
        'CBP_port_director','CBP_port_director_confidence_score', 'CBP_port_director_page_number', 
        'CBP_port_director_x1_coordinate','CBP_port_director_y1_coordinate', 'CBP_port_director_x2_coordinate',
        'CBP_port_director_y2_coordinate','CBP_port_director_x3_coordinate', 'CBP_port_director_y3_coordinate', 
        'CBP_port_director_x4_coordinate','CBP_port_director_y4_coordinate', 
        'consignee', 'consignee_confidence_score', 'consignee_page_number','consignee_x1_coordinate',
        'consignee_y1_coordinate', 'consignee_x2_coordinate', 'consignee_y2_coordinate','consignee_x3_coordinate',
        'consignee_y3_coordinate', 'consignee_x4_coordinate', 'consignee_y4_coordinate', 
        ...
        'foreign_port_of_lading_x4_coordinate', 'foreign_port_of_lading_y4_coordinate', 
        'bill_no', 'bill_no_confidence_score', 'bill_no_page_number', 'bill_no_x1_coordinate', 'bill_no_y1_coordinate', 
        'bill_no_x2_coordinate', 'bill_no_y2_coordinate', 'bill_no_x3_coordinate','bill_no_y3_coordinate',
        'bill_no_x4_coordinate', 'bill_no_y4_coordinate', 
        'date_of_sailing', 'date_of_sailing_confidence_score','date_of_sailing_page_number',
        'date_of_sailing_x1_coordinate', 'date_of_sailing_y1_coordinate', 'date_of_sailing_x2_coordinate', 
        'date_of_sailing_y2_coordinate', 'date_of_sailing_x3_coordinate', 'date_of_sailing_y3_coordinate', 
        'date_of_sailing_x4_coordinate', 'date_of_sailing_y4_coordinate', 
        ...
        'imported_on_vessel_or_carrier_y4_coordinate',
        'flag', 'flag_confidence_score', 'flag_page_number','flag_x1_coordinate', 'flag_y1_coordinate', 
        'flag_x2_coordinate', 'flag_y2_coordinate', 'flag_x3_coordinate', 'flag_y3_coordinate', 'flag_x4_coordinate', 
        'flag_y4_coordinate', 
        'date_imported', 'date_imported_confidence_score', 'date_imported_page_number','date_imported_x1_coordinate', 
        'date_imported_y1_coordinate', 'date_imported_x2_coordinate', 'date_imported_y2_coordinate', 
        'date_imported_x3_coordinate','date_imported_y3_coordinate','date_imported_x4_coordinate',
        'date_imported_y4_coordinate', 
        'via_last_foreign_port','via_last_foreign_port_confidence_score', 'via_last_foreign_port_page_number', 
        'via_last_foreign_port_x1_coordinate','via_last_foreign_port_y1_coordinate','via_last_foreign_port_x2_coordinate',
        'via_last_foreign_port_y2_coordinate','via_last_foreign_port_x3_coordinate','via_last_foreign_port_y3_coordinate', 
        'via_last_foreign_port_x4_coordinate', 'via_last_foreign_port_y4_coordinate', 
        'exported_from', 'exported_from_confidence_score', 'exported_from_page_number','exported_from_x1_coordinate',
        'exported_from_y1_coordinate', 'exported_from_x2_coordinate','exported_from_y2_coordinate', 
        'exported_from_x3_coordinate', 'exported_from_y3_coordinate', 'exported_from_x4_coordinate', 
        'exported_from_y4_coordinate', 
        'exported_date','exported_date_confidence_score', 'exported_date_page_number', 'exported_date_x1_coordinate', 
        ...
        'exported_date_y4_coordinate', 
        'goods_now_at', 'goods_now_at_confidence_score','goods_now_at_page_number', 'goods_now_at_x1_coordinate', 
        'goods_now_at_y1_coordinate','goods_now_at_x2_coordinate', 'goods_now_at_y2_coordinate',
        'goods_now_at_x3_coordinate', 'goods_now_at_y3_coordinate', 'goods_now_at_x4_coordinate','goods_now_at_y4_coordinate', 
        ...
        'MAWB_number_y1_coordinate', 'MAWB_number_x2_coordinate', 'MAWB_number_y2_coordinate', 'MAWB_number_x3_coordinate',
        'MAWB_number_y3_coordinate', 'MAWB_number_x4_coordinate', 'MAWB_number_y4_coordinate', 
        ...
        'gross_weight_y4_coordinate', 
        'gross_weight_uom','gross_weight_uom_confidence_score','gross_weight_uom_page_number',
        'gross_weight_uom_x1_coordinate','gross_weight_uom_y1_coordinate','gross_weight_uom_x2_coordinate',
        'gross_weight_uom_y2_coordinate','gross_weight_uom_x3_coordinate','gross_weight_uom_y3_coordinate',
        'gross_weight_uom_x4_coordinate','gross_weight_uom_y4_coordinate'
        'container_number', 'container_number_confidence_score', 
        ...
        'SLAC_x2_coordinate', 'SLAC_y2_coordinate', 'SLAC_x3_coordinate', 'SLAC_y3_coordinate','SLAC_x4_coordinate',
        'SLAC_y4_coordinate', 
        'SLAC_uom','SLAC_uom_confidence_score','SLAC_uom_page_number','SLAC_uom_x1_coordinate','SLAC_uom_y1_coordinate',
        'SLAC_uom_x2_coordinate','SLAC_uom_y2_coordinate','SLAC_uom_x3_coordinate','SLAC_uom_y3_coordinate',
        'SLAC_uom_x4_coordinate','SLAC_uom_y4_coordinate',
        'Value_in_dollars', 'Value_in_dollars_confidence_score','Value_in_dollars_page_number', 
        'Value_in_dollars_x1_coordinate', 'Value_in_dollars_y1_coordinate', 'Value_in_dollars_x2_coordinate', 
        'Value_in_dollars_y2_coordinate', 'Value_in_dollars_x3_coordinate','Value_in_dollars_y3_coordinate', 
        'Value_in_dollars_x4_coordinate', 'Value_in_dollars_y4_coordinate',
