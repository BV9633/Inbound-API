...
MINIMUM_CONFIDENCE=os.getenv("min_confidence_percentage")
...
table_not_found="Table not found: Please check if the table exists and the name is correct."
    ...
    try:
        ...
        data_string=f"""
            SELECT
                    ...
                    CASE 
                        WHEN LOWER(status) = 'processed' AND minimum_confidence >= {MINIMUM_CONFIDENCE} THEN 'ai_processed'
                        WHEN LOWER(status) = 'processed' AND minimum_confidence < {MINIMUM_CONFIDENCE} THEN 'manual_processed'
                        ELSE 'other' 
    ...
    try:
        ...
        sql = f"""
            WITH 
                ...
                SELECT 
                    COUNTIF(source = 'Invoice' AND LOWER(status) = 'processed' AND minimum_confidence >= {MINIMUM_CONFIDENCE}) AS invoice_auto,
                    COUNTIF(source = 'Invoice' AND LOWER(status) = 'processed' AND minimum_confidence < {MINIMUM_CONFIDENCE}) AS invoice_manual,
                    ...
                    COUNTIF(source = 'Waybill' AND LOWER(status) = 'processed' AND minimum_confidence >= {MINIMUM_CONFIDENCE}) AS waybill_auto,
                    ...
                    COUNTIF(source = 'Waybill' AND LOWER(status) = 'processed' AND minimum_confidence < {MINIMUM_CONFIDENCE}) AS waybill_manual,
                    COUNTIF(source = 'CBP' AND LOWER(status) = 'processed' AND minimum_confidence >= {MINIMUM_CONFIDENCE}) AS cbp_auto,
                    COUNTIF(source = 'CBP' AND LOWER(status) = 'processed' AND minimum_confidence < {MINIMUM_CONFIDENCE}) AS cbp_manual,
                    ...
                    COUNTIF(LOWER(status) = 'processed' AND minimum_confidence >= {MINIMUM_CONFIDENCE}) AS total_auto,
                    COUNTIF(LOWER(status) = 'processed' AND minimum_confidence < {MINIMUM_CONFIDENCE}) AS total_manual,
