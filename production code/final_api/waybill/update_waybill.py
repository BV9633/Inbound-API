...
class WaybillUpdater:
    ...
    SCALAR_FIELDS = [
        ...
        'HAWB_number_y4_coordinate', 
        'country_of_export', 'country_of_export_confidence_score', 
        ...
        'ASN_number_y3_coordinate', 'ASN_number_x4_coordinate', 'ASN_number_y4_coordinate', 
        'flight_data', 'flight_data_confidence_score', 'flight_data_page_number', 'flight_data_x1_coordinate', 
        ...
        'MAWB_number_y4_coordinate', 
        'vessel_or_voyage', 'vessel_or_voyage_confidence_score', 'vessel_or_voyage_page_number', 
        'vessel_or_voyage_x1_coordinate', 'vessel_or_voyage_y1_coordinate', 'vessel_or_voyage_x2_coordinate', 
        'vessel_or_voyage_y2_coordinate', 'vessel_or_voyage_x3_coordinate','vessel_or_voyage_y3_coordinate',
        'vessel_or_voyage_x4_coordinate','vessel_or_voyage_y4_coordinate',
        'total_quantity', 'total_quantity_confidence_score', 'total_quantity_page_number', 
        'total_quantity_x1_coordinate', 'total_quantity_y1_coordinate', 'total_quantity_x2_coordinate', 
        'total_quantity_y2_coordinate', 'total_quantity_x3_coordinate', 'total_quantity_y3_coordinate', 
        'total_quantity_x4_coordinate', 'total_quantity_y4_coordinate', 'total_quantity_uom', 
        'total_quantity_uom_confidence_score', 'total_quantity_uom_page_number', 
        'total_quantity_uom_x1_coordinate', 'total_quantity_uom_y1_coordinate','total_quantity_uom_x2_coordinate',
        'total_quantity_uom_y2_coordinate', 'total_quantity_uom_x3_coordinate', 
        'total_quantity_uom_y3_coordinate', 'total_quantity_uom_x4_coordinate', 'total_quantity_uom_y4_coordinate',
        'volume', 'volume_confidence_score', 'volume_page_number', 'volume_x1_coordinate', 'volume_y1_coordinate', 
        'volume_x2_coordinate', 'volume_y2_coordinate', 'volume_x3_coordinate', 'volume_y3_coordinate', 
        'volume_x4_coordinate', 'volume_y4_coordinate', 
        'volume_uom', 'volume_uom_confidence_score', 'volume_uom_page_number', 'volume_uom_x1_coordinate', 
        'volume_uom_y1_coordinate', 'volume_uom_x2_coordinate', 'volume_uom_y2_coordinate', 'volume_uom_x3_coordinate', 
        'volume_uom_y3_coordinate', 'volume_uom_x4_coordinate', 'volume_uom_y4_coordinate',
    ...
    LINE_ITEM_FIELDS = [
       ...
       'SLAC_uom', 'SLAC_uom_confidence_score', 'SLAC_uom_page_number', 'SLAC_uom_x1_coordinate', 
       'SLAC_uom_y1_coordinate', 'SLAC_uom_x2_coordinate', 'SLAC_uom_y2_coordinate', 'SLAC_uom_x3_coordinate', 
       'SLAC_uom_y3_coordinate', 'SLAC_uom_x4_coordinate', 'SLAC_uom_y4_coordinate',
       'gross_weight', 'gross_weight_confidence_score', 'gross_weight_page_number', 'gross_weight_x1_coordinate',
       'gross_weight_y1_coordinate','gross_weight_x2_coordinate','gross_weight_y2_coordinate','gross_weight_x3_coordinate',
       'gross_weight_y3_coordinate','gross_weight_x4_coordinate','gross_weight_y4_coordinate', 
       'gross_weight_uom', 'gross_weight_uom_confidence_score', 'gross_weight_uom_page_number','gross_weight_uom_x1_coordinate',
       'gross_weight_uom_y1_coordinate', 'gross_weight_uom_x2_coordinate','gross_weight_uom_y2_coordinate',
       'gross_weight_uom_x3_coordinate', 'gross_weight_uom_y3_coordinate', 'gross_weight_uom_x4_coordinate',
       'gross_weight_uom_y4_coordinate',
       ...
       'chargable_weight_x4_coordinate', 'chargable_weight_y4_coordinate',
       'chargable_weight_uom', 'chargable_weight_uom_confidence_score', 'chargable_weight_uom_page_number',
       'chargable_weight_uom_x1_coordinate', 'chargable_weight_uom_y1_coordinate','chargable_weight_uom_x2_coordinate',
